...
Name: PyGUI
Version: 2.5.4
Summary: Pythonic Cross-Platform GUI Framework
Home-page: http://www.cosc.canterbury.ac.nz/greg.ewing/python_gui
Author: Gregory Ewing
Author-email: greg.ewing@canterbury.ac.nz
License: This is free software. You are welcome to use it however you want.
Description: Welcome to PyGUI
        ================
